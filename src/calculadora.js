...
function Calculadora() {  
  ...
  const [calcular, concaternarNumero, SOMA, SUBTRACAO, DIVISAO, MULTIPLICACAO] = CalculadoraService();
    ...
    function adicionarNumero(numero) {
      let resultado;
      if (operacao === null) {
        resultado = concaternarNumero(numero1, numero);
        setNumero1(resultado);
      } else {
        resultado = concaternarNumero(numero2, numero);
    ...
    function definirOperacao(op) {
      // apeans defini a operacao caso ela nao exista
      if (operacao === null) {
        setOperacao(op);
        return;
      }
      // caso a operacao extiver definida e numero 2 selecionado, realiza o calculo da operacao
      if (numero2 !== null) {
